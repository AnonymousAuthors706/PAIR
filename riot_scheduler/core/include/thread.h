 ...
 */
static inline __attribute__((always_inline)) thread_t *thread_get_unchecked(kernel_pid_t pid)
{
 ...
 */
static inline __attribute__((always_inline)) kernel_pid_t thread_getpid(void)
{
 ...
 */
static inline __attribute__((always_inline)) thread_status_t thread_get_status(const thread_t *thread)
{
