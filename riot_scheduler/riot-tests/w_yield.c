 ...
 *
 * RIOT Example #2: Thread creation with yield
 *
 * Expected behaviour:
 *      P3OUT : 0x50, 0x02, 0x03, ..., 0x0b, 0x0c, 0xde, 0xdf, ...
 *      P1OUT : 0xee
 * 
...
/**
 * This thread will execute exactly one time and only change P1OUT to 0xee (goes to sleep in first
 * iteration and never wakes up again)
 */
void *blink_thread(void *arg)
{
        (void)arg;
